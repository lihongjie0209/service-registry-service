...
LDFLAGS = -s -w -X github.com/lihongjie0209/service-registry-service/internal/buildinfo.Version=$(VERSION) -X github.com/lihongjie0209/service-registry-service/internal/buildinfo.Commit=$(COMMIT) -X github.com/lihongjie0209/service-registry-service/internal/buildinfo.BuildTime=$(BUILD_TIME)
...
docker-build:
	docker build \
		...
		--tag service-registry-service:$(VERSION) .
