...
func setDefaults(v *viper.Viper) {
	v.SetDefault("app.name", "service-registry-service")
	...
	v.SetDefault("database.schema", "service_registry")
	...
	v.SetDefault("jwt.issuer", "service-registry-service")
	...
	v.SetDefault("migration.table", "service_registry_schema_migrations")
